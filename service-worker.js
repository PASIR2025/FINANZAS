const CACHE='pasir-gestion-v4.9.1-real';
const CORE=[
  './','./index.html','./manifest.webmanifest',
  './assets/css/styles.css?v=4.9.1','./assets/js/app-v4.9.1.js?v=4.9.1',
...
async function networkFirst(request){
  try{
    ...
    return response;
  }catch(e){return (await caches.match(request))||(request.mode==='navigate'?caches.match('./index.html'):Response.error())}
}
