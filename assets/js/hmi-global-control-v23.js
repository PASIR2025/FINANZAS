(function(){
  ...
  const VERSION='V24-AUTONOMOUS-LOCAL';
  ...
  function ensureCodegenGlobalUi(){
    ...
    if(status)status.textContent='Control autónomo V24 activo · PLC funciona sin HMI · Solo HMI aísla sensores físicos de proceso · seguridad física conserva prioridad.';
    updateModeUi();
  }
  ...
  function upgradeGeneratedCode(source){
    ...
    if(code.includes('SIMUPLC HMI READY CODE V24'))return code;
    ...
    code=code
      .replace(/SIMUPLC HMI READY CODE V(?:12|15|16|17|18|20)/g,'SIMUPLC HMI READY CODE V24')
      .replace(/READY_CODE_V(?:12|15|16|17|18|20)/g,'READY_CODE_V24')
      .replace(/GENERADOR HMI V(?:12|15|16|17|18|20)/g,'GENERADOR HMI V24');
