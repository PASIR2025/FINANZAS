-- PASIR Gestión V4.6 · Supabase multiusuario
...
create policy "pasir tx delete managers" on public.pasir_transactions for delete using (public.pasir_is_manager(workspace_id));
